    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/login/**", "/", "/error", "/swagger-config/**", "/api-docs/**",
                                "/swagger/**", "/swagger-ui/**", "/swagger-resources/**", "/download").permitAll()
                        .requestMatchers(HttpMethod.POST,"/user").permitAll()
                        .anyRequest().authenticated());
        http
                .addFilterBefore(new JWTFilter(jwtUtil,userReader), LoginFilter.class);
        http
